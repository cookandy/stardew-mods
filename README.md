...
- [Stardew Valley](https://www.stardewvalley.net/) version `1.5.6`
- [SMAPI](https://smapi.io/) version `3.17.2`
...
| :------------- | :---------- | :---------- | :----------- |
|  [Advanced Save Backup](https://www.nexusmods.com/stardewvalley/mods/435) | Automatically backs up your saves when loading the game and every night when you sleep.  | `1.11.0`    | |
...
| [Automate](https://www.nexusmods.com/stardewvalley/mods/1063) |  Place a chest next to a machine (like a furnace or crystalarium), and the machine will automatically pull raw items from the chest and push processed items into it.	| `1.28.0` | |
...
| [Better Ranching](https://www.nexusmods.com/stardewvalley/mods/859) | Prevents doomed milking/shearing attempts and adds an indicator when animals can be petted, milked, or sheared.	| `1.9.0` | |
| [Bigger Backpack](https://www.nexusmods.com/stardewvalley/mods/1845) | Buy a bigger backpack at Pierre's for only 50,000g. | `5.0` | |
| [Chests Anywhere](https://www.nexusmods.com/stardewvalley/mods/518) | Access your chests, dressers, fridge, shipping bin, and Junimo huts from anywhere and organise them your way. | `1.22.3` | |
...
| [CJB Cheats Menu](https://www.nexusmods.com/stardewvalley/mods/4) | A simple in-game cheats menu with lots of cheats. | `1.32.1` | |
| [Content Patcher](https://www.nexusmods.com/stardewvalley/mods/1915) | Loads content packs that change the game's images and data without replacing XNB files. | `1.28.2` | |
| [Custom Companions](https://www.nexusmods.com/stardewvalley/mods/8626) | Framework for creating custom entities that can be spawned on maps or follow you around in Stardew Valley. | `2.5.0` | |
| [Custom NPC Exclusions](https://www.nexusmods.com/stardewvalley/mods/7089) | Allows other mods to exclude NPCs from certain quests and events. | `1.4.0` | |
...
| [East Scarp](https://www.nexusmods.com/stardewvalley/mods/5787) | An expansion adding new NPCs; new locations; new fish; shops; special orders - and secrets. | `2.1.4` | |
...
| [Generic Mod Config Menu](https://www.nexusmods.com/stardewvalley/mods/5098) | A config menu framework for mods. | `1.9.3` | |
...
| [JSON Assets](https://www.nexusmods.com/stardewvalley/mods/1720) | Successor to Custom Crops. | `1.10.7` | |
| [Lookup Anything](https://www.nexusmods.com/stardewvalley/mods/541) | See live info about whatever's under your cursor. | `1.38.0` | Changed hotkey. See [wiki](https://github.com/cookandy/stardew-mods/wiki/LookupAnything) |
...
| [NPC Map Locations](https://www.nexusmods.com/stardewvalley/mods/239) | Shows the locations of NPC and farmers on the map page and on a minimap. | `2.11.1` | |
...
| [Ridgeside Village](https://www.nexusmods.com/stardewvalley/mods/7286) | Adds 24 new NPCs, a new location, forage, custom music, and more. | `2.2.3` |
...
| [SpaceCore](https://www.nexusmods.com/stardewvalley/mods/1348) | Required by a few mods. | `1.9.2` | |
| [Stardew Valley Expanded](https://www.nexusmods.com/stardewvalley/mods/3753) | This expansion features 26 new locations, 160 new character events, 12 new NPCs, a new village, 800 location messages, and more. | `1.14.17` | Some options changed. See [wiki](https://github.com/cookandy/stardew-mods/wiki/SVE)|
...
| [TMXL Map Toolkit](https://www.nexusmods.com/stardewvalley/mods/1820) | Toolkit for adding/editing/replacing maps and creating buildables. | `1.23.1` | |
| [Tractor Mod](https://www.nexusmods.com/stardewvalley/mods/1401) | Buy a tractor to more efficiently work with crops, clear twigs and rocks, etc. | `4.16.1` | |
...
| [Wear More Rings](https://www.nexusmods.com/stardewvalley/mods/3214) | Configure the amount of ring slots in your inventory. By default adds 6 additional ring slots. | `5.1` | |
...
| Name      | Description | Version    | Notes     |
| :------------- | :---------- | :---------- | :----------- |
| [DaisyNiko's Tilesheets](https://www.nexusmods.com/stardewvalley/mods/4736) | Adds extra tilesheets to your game for other mods to use | `1.8.0` | |
...
| [Yagisan - Custom NPCs for NPC Map Locations](https://www.nexusmods.com/stardewvalley/mods/8174) | Show custom NPC's on the world map using NPC Map Locations. | `1.1.21` | |
