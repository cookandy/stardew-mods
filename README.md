...
| [Automate](https://www.nexusmods.com/stardewvalley/mods/1063) |  Place a chest next to a machine (like a furnace or crystalarium), and the machine will automatically pull raw items from the chest and push processed items into it.	| `2.5.0` | |
| [Better Ranching](https://www.nexusmods.com/stardewvalley/mods/859) | Prevents doomed milking/shearing attempts and adds an indicator when animals can be petted, milked, or sheared.	| `2.0.5` | |
| [Bigger Backpack](https://www.nexusmods.com/stardewvalley/mods/1845) | Buy a bigger backpack at Pierre's for only 50,000g. | `7.3.0` | |
| [Chests Anywhere](https://www.nexusmods.com/stardewvalley/mods/518) | Access your chests, dressers, fridge, shipping bin, and Junimo huts from anywhere and organise them your way. | `1.30.0` | |
| [CJB Cheats Menu](https://www.nexusmods.com/stardewvalley/mods/4) | A simple in-game cheats menu with lots of cheats. | `1.40.0` | |
...
| [Event Reepeater](https://www.nexusmods.com/stardewvalley/mods/3642) | Add depth to your stories with the option to Repeat events over and over as you need them. | `6.6.0` | |
| [Expanded Preconditions Utility](https://www.nexusmods.com/stardewvalley/mods/6529) | A utility mod built on top of the game's preconditions system to offer a conditions system any mod can use | `1.1.1`| |
| [Fall 28 Snow Day](https://www.nexusmods.com/stardewvalley/mods/486) | Makes snow fall on the last day of Fall. | `1.9.0` | |
| [Farm Type Manager](https://www.nexusmods.com/stardewvalley/mods/3231) | A spawning framework that allows players and modders to spawn customizable features from Stardew's farm types. | `1.26.1` | |
| [Festival of the Mundane](https://www.nexusmods.com/stardewvalley/mods/4630) | The Shadows have their own Spirit's Eve festival in the sewers. Come visit them and see what it's about. | `1.1.3-unofficial.2-Dasorik` | |
| [Generic Mod Config Menu](https://www.nexusmods.com/stardewvalley/mods/5098) | A config menu framework for mods. | `1.16.0` | |
| [Gift Taste Helper Continued x2](https://www.nexusmods.com/stardewvalley/mods/21001) | Displays a helpful tooltip that shows an NPC's favourite gifts when hovering over their birthday on the calendar or the social page. | `1.2.5` | |
| [Grandpa's Farm](https://www.nexusmods.com/stardewvalley/mods/3753) | Grandpa's Farm for [Stardew Valley Expanded](https://www.nexusmods.com/stardewvalley/mods/3753). | `1.15.11` | |
...
| [JSON Assets](https://www.nexusmods.com/stardewvalley/mods/1720) | Successor to Custom Crops. | `1.11.11` | |
| [Lookup Anything](https://www.nexusmods.com/stardewvalley/mods/541) | See live info about whatever's under your cursor. | `1.54.0` | Changed hotkey. See [wiki](https://github.com/cookandy/stardew-mods/wiki/LookupAnything) |
| [Mail Framework Mod](https://www.nexusmods.com/stardewvalley/mods/1536) | Framework to use the in game mailbox. | `1.20.0` | |
...
| [Non-Destructive NPCs](https://www.nexusmods.com/stardewvalley/mods/5176) | Makes NPCs not destroy objects placed by the player in their paths. | `1.6.0-unofficial` | |
| [NPC Map Locations](https://www.nexusmods.com/stardewvalley/mods/239) | Shows the locations of NPC and farmers on the map page and on a minimap. | `3.5.0` | |
...
| [Producer Framework](https://www.nexusmods.com/stardewvalley/mods/4970) | Toolkit for Smapi Mods. | `1.9.8` | |
...
| [ShopTileFramework](https://www.nexusmods.com/stardewvalley/mods/5005) | A Framework mod that allows modders to add custom shops to the game, as well as edit vanilla shop. | `1.0.12` | |
| [Skull Cavern Elevator](https://www.nexusmods.com/stardewvalley/mods/963) | Adds an elevator to the Skull Cavern. | `1.6.2` | |
| [SpaceCore](https://www.nexusmods.com/stardewvalley/mods/1348) | Required by a few mods. | `1.28.4` | |
