...
- [SMAPI](https://smapi.io/) version `3.13.2`
...
| [Automate](https://www.nexusmods.com/stardewvalley/mods/1063) |  Place a chest next to a machine (like a furnace or crystalarium), and the machine will automatically pull raw items from the chest and push processed items into it.	| `1.24.1` | |
...
| [Chests Anywhere](https://www.nexusmods.com/stardewvalley/mods/518) | Access your chests, dressers, fridge, shipping bin, and Junimo huts from anywhere and organise them your way. | `1.20.18` | |
...
| [CJB Cheats Menu](https://www.nexusmods.com/stardewvalley/mods/4) | A simple in-game cheats menu with lots of cheats. | `1.29.2` | |
| [Content Patcher](https://www.nexusmods.com/stardewvalley/mods/1915) | Loads content packs that change the game's images and data without replacing XNB files. | `1.24.5` | |
| [Custom Companions](https://www.nexusmods.com/stardewvalley/mods/8626) | Framework for creating custom entities that can be spawned on maps or follow you around in Stardew Valley. | `2.0.0` | |
...
| [Custom NPC Fixes](https://www.nexusmods.com/stardewvalley/mods/3849) | Fixes NPC spawning in custom locations, pathing to custom locations, and schedules for new NPCs. | `1.2.3` | |
| [DeepWoods](https://www.nexusmods.com/stardewvalley/mods/2571) | Adds an explorable forest to the secret woods. | `2.0.0-beta` | Modified to be slightly easier. See [wiki](https://github.com/cookandy/stardew-mods/wiki/DeepWoods)|
...
| [East Scarp](https://www.nexusmods.com/stardewvalley/mods/5787) | An expansion adding new NPCs; new locations; new fish; shops; special orders - and secrets. | `2.0.4` | |
| [Event Reepeater](https://www.nexusmods.com/stardewvalley/mods/3642) | Add depth to your stories with the option to Repeat events over and over as you need them. | `6.4.1` | |
...
| [Imaged](https://www.nexusmods.com/stardewvalley/mods/7218) | Provides non-interactive image recoloring. | `1.2` | |
| [JSON Assets](https://www.nexusmods.com/stardewvalley/mods/1720) | Successor to Custom Crops. | `1.10.1` | |
| [Lookup Anything](https://www.nexusmods.com/stardewvalley/mods/541) | See live info about whatever's under your cursor. | `1.35.7` | Changed hotkey. See [wiki](https://github.com/cookandy/stardew-mods/wiki/LookupAnything) |
...
| [NPC Map Locations](https://www.nexusmods.com/stardewvalley/mods/239) | Shows the locations of NPC and farmers on the map page and on a minimap. | `2.7.1` | |
...
| [Stardew Valley Expanded](https://www.nexusmods.com/stardewvalley/mods/3753) | This expansion features 26 new locations, 160 new character events, 12 new NPCs, a new village, 800 location messages, and more. | `1.13.16` | Some options changed. See [wiki](https://github.com/cookandy/stardew-mods/wiki/SVE)|
...
| [Tractor Mod](https://www.nexusmods.com/stardewvalley/mods/1401) | Buy a tractor to more efficiently work with crops, clear twigs and rocks, etc. | `4.14.7` | |
...
| [Lumisteria Tilesheets - Indoor](https://www.nexusmods.com/stardewvalley/mods/9599) | A resource mod for map modder adding a new tilesheet containing various furnitures to use in their map. | `1.1.0` | |
